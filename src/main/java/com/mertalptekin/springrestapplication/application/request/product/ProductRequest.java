...
public record ProductRequest(@JsonProperty("pag_size") Integer pageSize,@JsonProperty("page_number") Integer pageNumber,@JsonProperty("search_key") String searchKey, @JsonProperty("sort_key") String sortKey) {
}
